...
int main(int argc, char **argv) {
    ...
    double s = (svd.singularValues()(0)+svd.singularValues()(1) )/2.0;
    Eigen::Matrix3d Sn;
    Sn << s, 0, 0, 0, s, 0, 0, 0, 0;
    ...
    Matrix3d t_wedge1 = U * Rz1 * Sn * U.transpose();
    Matrix3d t_wedge2 = U * Rz2 * Sn * U.transpose();
